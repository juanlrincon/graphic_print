...
<tr>
	...
	<th><?php echo $paginator->sort('modified_id');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $pais['Pais']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $pais['Pais']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $pais['Pais']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $pais['Pais']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
