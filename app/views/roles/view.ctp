...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Rol', true), array('action' => 'edit', $rol['Rol']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Rol', true), array('action' => 'delete', $rol['Rol']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $rol['Rol']['id'])); ?> </li>
		<li><?php echo $html->link(__('List Rol', true), array('action' => 'index')); ?> </li>
