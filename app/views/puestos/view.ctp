...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Puesto', true), array('action' => 'edit', $puesto['Puesto']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Puesto', true), array('action' => 'delete', $puesto['Puesto']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $puesto['Puesto']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($puesto['Usuario'] as $usuario):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
